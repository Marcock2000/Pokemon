...
const btn =
  "inline-flex items-center px-5 py-1.5 border border-gray-300 shadow-sm font-medium rounded-full text-gray-700 bg-white hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500";
    ...
    <div className="h-screen w-screen flex flex-col justify-between items-center relative">
      ...
      {pokemonPair && (
        <div className="p-8 flex justify-between items-center max-w-2xl flex-col md:flex-row animate-fade-in">
          ...
          />
          <div className="p-8 italic font-mono text-xl">{"vs"}</div>
          <PokemonListing
      ...
      <div className="w-full text-xl font-mono text-center pb-2">
        <Link href="/results">
          <a>Results</a>
        </Link>
...
const PokemonListing: React.FC<{
  ...
  return (
    ...
    >
      <div className="text-xl font-mono text-center capitalize mt-[-0.5rem]">
        {props.pokemon.name}
      </div>
      <Image
